...
import com.yudhapn.moviecatalogue.databinding.FragmentDetailTvShowBinding;
...
public class DetailTvShowFragment extends Fragment implements RetrofitCallback, NetworkReceiver.NetworkCallback {
    private static final String TAG = "DetailTvShowFragment";
    private FragmentDetailTvShowBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_detail_tv_show, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewPager = view.findViewById(R.id.tvshow_view_pager);
        tabLayout = view.findViewById(R.id.tvshow_tab_layout);
        ...
        appBarLayout = view.findViewById(R.id.appBarTvLayout);
        shimmer.startShimmer();
    }

    private void updateUI() {
        assert getArguments() != null;
        TvShow show2 = DetailTvShowFragmentArgs.fromBundle(getArguments()).getTvshowArgs();
        viewModel.getDetailTvShow(favoriteHelper, show2.getId().toString(), this).observe(this, detailTvShow -> {
            ...
            Objects.requireNonNull(((AppCompatActivity) Objects.requireNonNull(getActivity()))
                    .getSupportActionBar()).setTitle(detailTvShow.getName());
            likeButton.setOnClickListener(v -> viewModel.setFavorite(favoriteHelper, detailTvShow));
